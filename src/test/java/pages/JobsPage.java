...
public class JobsPage {
    ...
    @FindBy(className = "package")
    WebElement packageEl;
    ...
    public WebElement getFirstJob(int index){
        waitForVisibility(jobsListElements.get(index));
        return jobsListElements.get(index);
    }
    ...
    public WebElement getPackageEl(){
        waitForVisibility(packageEl);
        return packageEl;
    }

    public void clearInputField(){
        searchInputFieldElement.clear();
    }
